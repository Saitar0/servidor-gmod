...
--
VOTING.Settings.VotingTitle = "Eleição do prefeito" --Main title
VOTING.Settings.ResultsTitle = "Nosso NOVO prefeito eleito!" --Main title for results
VOTING.Settings.NoticePrefix = "[ELEIÇÕES]" --Chat text prefix

VOTING.Settings.NPCEnabled = true --Spawn Mayor Elections NPC?
VOTING.Settings.NPCTitleText = "Secretária do prefeito" --NPC Title above head
...
//VOTING.CustomFunctionFailed = "Você não tem nível suficiente para entrar em uma eleição de prefeito!"