...
PVP_COMBAT_MODULE:Setup(function()
	...
	local function EntityTakeDamage(their_return, victim, dmginfo)
		if (their_return ~= nil and their_return[1] == true) then return end
	...
	GAS.Hooking:InferiorHook("DoPlayerDeath", "logging:PvP:TrackDeathDmg", function(victim, attacker, dmginfo)
		...
		EntityTakeDamage(nil, victim, dmginfo)
	end)
