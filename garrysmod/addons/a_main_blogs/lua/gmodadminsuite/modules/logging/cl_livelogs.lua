...
function GAS.Logging:OpenLiveLogs()
	...
	function GAS_Logging_LiveLogs:AddLog(logtbl)
		...
		local created_livelog = table.insert(GAS_Logging_LiveLogs.Logs, markup.Parse("<font=gas_logging_livelogs>" .. GAS.Logging:FormatMarkupLog(logtbl, GAS.Logging.LiveLogs_Config.color) .. "</font>", max_width))
