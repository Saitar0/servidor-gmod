...
function base_table:PaintScroll(panel)
	...
	scr.Paint = function(_, w, h)
		draw.RoundedBox(4, 0, 0, w, h, /* 76561198014125016 styl.header */ styl.bg)
	end
...
// https://facepunch.com/showthread.php?t=1522945&p=50524545&viewfull=1#post50524545|76561198014124993
