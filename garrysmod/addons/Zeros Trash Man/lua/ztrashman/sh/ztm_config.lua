...
// The language , en , de , cn , ru , fr , es , pl
// OTIMIZADO: Português do Brasil
ztm.config.SelectedLanguage = "ptbr"

// Currency
ztm.config.Currency = "R$"
...
ztm.config.Recycler = {
    ...
    // Here you can add more recycle typesg
    recycle_types = {
        [1] = {
